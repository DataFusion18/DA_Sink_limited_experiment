...
A_obs <- read.csv("https://raw.githubusercontent.com/kashifmahmud/EucPVE/master/calculated%20data/Asat_obs.csv")
...
plotsumm <- read.csv("https://raw.githubusercontent.com/kashifmahmud/EucPVE/master/raw%20data/plot_summary.csv")
